...
// username & password bebas diganti.
// role: 'admin' (wali kelas, akses penuh) | 'pengurus' (ketua/wakil/sekertaris/bendahara,
//        boleh edit jadwal piket & link IG/TikTok) | 'user' (siswa biasa)
// slug WAJIB sama persis kayak slug di tabel students (buat nentuin siswa mana yang boleh diedit)
export const ACCOUNTS = [
    { username: 'mujawiroh', password: 'mujawiroh123', role: 'admin' }, // Hj. Mujawiroh, S.Pd.i - Wali Kelas
    ...
    { username: 'aditya-pratama-suhendi', password: 'aditya-pratama-suhendi', role: 'pengurus', slug: 'aditya-pratama-suhendi' }, // Aditya Pratama Suhendi - NIS 11252071 — Wakil Sekertaris
    ...
    { username: 'axelle-ashwan-finnegan', password: 'axelle-ashwan-finnegan', role: 'pengurus', slug: 'axelle-ashwan-finnegan' }, // Axelle Ashwan Finnegan - NIS 11252076 — Sekertaris
    ...
    { username: 'bayu-luthfiadi', password: 'bayu-luthfiadi', role: 'pengurus', slug: 'bayu-luthfiadi' }, // Bayu Luthfiadi - NIS 11252078 — Bendahara
    ...
    { username: 'farrel-surya-ramadhan', password: 'farrel-surya-ramadhan', role: 'pengurus', slug: 'farrel-surya-ramadhan' }, // Farrel Surya Ramadhan - NIS 11252081 — Ketua Kelas
    ...
    { username: 'muhamad-alfajri', password: 'muhamad-alfajri', role: 'pengurus', slug: 'muhamad-alfajri' }, // Muhamad Alfajri - NIS 11252020 — Wakil Bendahara
    ...
    { username: 'rezki-awalludin', password: 'rezki-awalludin', role: 'pengurus', slug: 'rezki-awalludin' }, // Rezki Awalludin - NIS 11252031 — Wakil Ketua Kelas
